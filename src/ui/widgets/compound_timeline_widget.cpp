...
public:
    ...
    void setup_menu(CompoundTimelineWidget* parent)
    {
        ...
        /// \todo rename Constant to Hold for consistency
        action_enter_hold.setData(QVariant::fromValue(model::KeyframeTransition::Constant));
        ...
        action_exit_hold.setData(QVariant::fromValue(model::KeyframeTransition::Constant));
    ...
    {
        action_enter->setText(tr("Incoming Transition"));
        action_exit->setText(tr("Outgoing Transition"));
...
void CompoundTimelineWidget::custom_context_menu(const QPoint& p)
{
    ...
    if ( d->menu_kf_exit )
    {
        ...
        if ( d->menu_kf_enter )
        {
            ...
            {
                case model::KeyframeTransition::Constant:
